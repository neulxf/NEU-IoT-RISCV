...
# create_clock -period 20.000 -name sys_clk_pin -waveform {0.000 10.000} -add [get_ports clk_100M]
...
# set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {btn_vec[0]}]
# set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports {btn_vec[1]}]
# set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {btn_vec[2]}]
# set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {btn_vec[3]}]
# set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {btn_vec[4]}]
...
# set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports uart0_rxd]
# set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports uart0_txd]
# set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports pd_rxd]
# #set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { JA[4] }]; #IO_L18N_T2_A23_15 Sch=ja[4]
# #set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports txd_0]
# set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports txd_1]
...
##VGA Connectors
##HSYNC
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports h_sync_o];
##VSYNC
set_property -dict { PACKAGE_PIN B12   IOSTANDARD LVCMOS33 } [get_ports v_sync_o];
###RED
